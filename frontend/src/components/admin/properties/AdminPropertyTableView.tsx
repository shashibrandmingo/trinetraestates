    ...
    <div className="bg-white rounded-xl border border-slate-200/90 shadow-sm overflow-hidden w-full">
      <div className="w-full overflow-x-auto custom-scrollbar">
        <table className="w-full min-w-[1020px] text-left border-collapse">
          ...
          <thead>
            <tr className="bg-slate-50/90 border-b border-slate-200 text-[10px] font-bold text-slate-500 uppercase tracking-wider whitespace-nowrap">
              <th className="py-2.5 pl-3 pr-2">Property</th>
              <th className="py-2.5 px-2">Type / Purpose</th>
              <th className="py-2.5 px-3">Location</th>
              <th className="py-2.5 px-3">Area</th>
              <th className="py-2.5 px-3">Pricing</th>
              <th className="py-2.5 px-2 text-center">Status</th>
              <th className="py-2.5 px-2.5">Owner / Source</th>
              <th className="py-2.5 px-2 text-left">Listed On</th>
              <th className="py-2.5 px-3 text-center sticky right-0 bg-slate-50/95 backdrop-blur-xs z-10 border-l border-slate-200/80 shadow-[-4px_0_6px_rgba(0,0,0,0.03)]">Actions</th>
            </tr>
          </thead>

          {/* Table Rows - High density sleek compact */}
                ...
                <tr key={i} className="animate-pulse">
                  ...
                  <td className="py-2.5 pl-3 pr-2 whitespace-nowrap">
                    <div className="flex items-center gap-2.5">
                      <div className="w-8 h-8 rounded-lg bg-slate-200 shrink-0 skeleton-shimmer" />
                ...
                return (
                  ...
                  <td className="py-2 pl-3 pr-2 whitespace-nowrap">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div className="min-w-0 max-w-[135px] xl:max-w-[170px]">
                        <div className="flex items-center gap-1.5">
                          <p className={`font-heading text-[11px] font-bold truncate transition-colors leading-tight ${
                            isClosed ? 'text-slate-600 group-hover:text-navy-900' : 'text-navy-950 group-hover:text-gold-600'
                          }`}>
                            {item.title}
                          </p>
                          {isClosed && (
                        ...
                        <div className="font-mono text-[9px] text-slate-400 font-medium truncate">
                  ...
                  <td className="py-2 px-2 whitespace-nowrap">
                    <div className="flex items-center gap-1.5">
                      ...
                      <div className="min-w-0">
                        <div className="font-bold text-navy-950 text-[10.5px] capitalize leading-tight">
                          {item.propertyType || 'Office'}
                        </div>
                        <div className="text-[9px] font-semibold text-slate-400 capitalize leading-tight mt-0.5">
                          {item.purpose || 'Rent'}
                        </div>
                      </div>
                    </div>
                  ...
                  <td className="py-2 px-3 whitespace-nowrap">
                    <div className="flex items-center gap-1">
                      <span className="text-emerald-600 shrink-0 text-[10px]">📍</span>
                      <div className="min-w-0">
                        <div className="font-bold text-navy-950 text-[10.5px] truncate">
                  ...
                  <td className="py-2 px-3 whitespace-nowrap">
                    <div className={`text-[10.5px] font-bold ${isClosed ? 'text-slate-400 line-through' : 'text-navy-950'}`}>
                      ₹ {item.monthlyRentInLakh} L/mo
                    </div>
                    <div className="text-[9px] text-slate-400 font-medium">
                      {isClosed ? (
                        <span className={`font-bold ${isSoldByMe ? 'text-amber-700' : 'text-rose-600'}`}>
                  ...
                  <td className="py-2 px-2.5 whitespace-nowrap">
                    <div className="flex items-center gap-1.5 min-w-0">
                      <div className="w-5 h-5 rounded-full bg-slate-100 text-slate-700 border border-slate-200 font-bold text-[8px] flex items-center justify-center shrink-0">
                        {ownerInitials}
                      </div>
                      <div className="min-w-0 max-w-[105px] xl:max-w-[130px]">
                        <div className="font-bold text-navy-950 truncate text-[10.5px]">
                  ...
                  {/* 9. Actions - Sticky right, always visible and never cut off */}
                  <td
                    className={`py-2 px-3 text-center relative whitespace-nowrap sticky right-0 bg-white group-hover:bg-slate-50 transition-colors border-l border-slate-200/80 shadow-[-4px_0_6px_rgba(0,0,0,0.03)] ${
                      ...
                      <button
                        ...
                        className={`p-1 rounded-md transition-colors cursor-pointer ${
                          isMenuOpen
                            ...
                            : 'hover:bg-slate-100 text-slate-400 hover:text-navy-900'
                        }`}
                        title="More Options"
                      >
